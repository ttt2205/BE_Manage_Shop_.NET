...
#pragma warning disable 612, 618
            ...
            // --- 1. CÁC BẢNG AUDIT (Lấy từ Version 1) ---
            ...
            // --- 2. CÁC BẢNG CHÍNH (Lấy từ Version 2 - Vì có cấu hình ColumnName và Mapping tốt hơn) ---
            ...
            // --- 3. CÁC RELATIONSHIP (Kết hợp cả 2 phiên bản) ---

            // Relation của Audit (Từ V1)
            modelBuilder.Entity("Manage_Store.Models.Entities.AuditSessions", b =>
            {
            ...
            // Relation của các bảng chính (Từ V2 - Có Navigation ngược lại như .WithMany("Orders"))
            modelBuilder.Entity("Manage_Store.Models.Entities.Order", b =>
            {
            ...
            // --- 4. NAVIGATION PROPERTIES (Kết hợp) ---
